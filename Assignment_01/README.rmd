...
Observations: The average and media PM2.5 levels appear lower in 2019 than 2004 and the maximum PM2.5 level measured is lower in 2019. This is the case when negative values are include but also when negative values are excluded from the statistics summary. 
...
Comparing PM2.5 levels between 2004 and 2019 at the site level
